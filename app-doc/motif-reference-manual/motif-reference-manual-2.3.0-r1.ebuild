...
LICENSE="OPL"
SLOT="0"
KEYWORDS="alpha amd64 arm hppa ~mips ppc64 sh x86 ~ppc-aix ~amd64-fbsd ~x86-fbsd ~amd64-linux ~x86-linux ~ppc-macos ~x86-macos ~sparc-solaris ~x64-solaris ~x86-solaris"
