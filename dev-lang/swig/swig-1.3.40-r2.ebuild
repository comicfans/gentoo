...
LICENSE="BSD BSD-2"
SLOT="1"
KEYWORDS="alpha amd64 arm hppa ppc64 s390 sh x86 ~ppc-aix ~x86-fbsd ~amd64-linux ~x86-linux ~ppc-macos ~x64-macos ~x86-macos ~sparc-solaris ~x64-solaris ~x86-solaris"
IUSE="ccache doc"
RESTRICT="test"
DEPEND=""
RDEPEND=""
