...
SLOT="0"
KEYWORDS="alpha amd64 arm arm64 hppa ~m68k ~mips ppc64 ~s390 ~sh x86 ~amd64-fbsd ~x86-fbsd ~amd64-linux ~x86-linux ~x86-macos ~sparc-solaris ~x64-solaris ~x86-solaris"
