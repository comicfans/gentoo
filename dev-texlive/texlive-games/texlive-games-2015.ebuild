...
TEXLIVE_MODULE_CONTENTS="bartel-chess-fonts chess chess-problem-diagrams chessboard chessfss crossword crosswrd egameps gamebook go hanoi havannah hexgame horoscop labyrinth logicpuzzle othello othelloboard pas-crosswords psgo reverxii rubik schwalbe-chess sgame skak skaknew sudoku sudokubundle xq xskak collection-games
"
...
TEXLIVE_MODULE_SRC_CONTENTS="chess-problem-diagrams.source chessboard.source chessfss.source crossword.source crosswrd.source gamebook.source go.source havannah.source horoscop.source rubik.source schwalbe-chess.source sudoku.source sudokubundle.source xskak.source "
